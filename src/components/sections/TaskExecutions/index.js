...
import TaskStatusFormat from '../../formats/TaskStatusFormat';

class TaskExecutions extends AbsSection {
  static propTypes = {
  ...
  get columns() {
    return [
      { id: 'status', format: TaskStatusFormat },
      columnDateTime('created_at'),
      columnDateTime('started_at'),
      columnDateTime('completed_at'),
    ];
  }
...
export default withStyles(styles)(TaskExecutions);
